...
public:
  ...
  static void drawCircle(float _x, float _y, float _r) { get()->_drawCircle(_x, _y, _r); }

  virtual void _drawCircle(float _x, float _y, float _r) {}
  ...
  static void setClipWindow(int _x0, int _y0, int _x1, int _y1) { get()->_setClipWindow(_x0, _y0, _x1, _y1); }

  virtual void _setClipWindow(int _x0, int _y0, int _x1, int _y1) {}

  static void clearClipWindow() { get()->_clearClipWindow(); }

  virtual void _clearClipWindow() {}
