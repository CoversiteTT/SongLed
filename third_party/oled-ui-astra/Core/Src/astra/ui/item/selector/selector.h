...
private:
  Menu *menu;
  bool listAnimActive = false;
  uint32_t listAnimStartMs = 0;
  float listStartX = 0.0f;
  float listStartY = 0.0f;
  float listStartW = 0.0f;
  float listStartH = 0.0f;
  uint32_t lastMoveMs = 0;
  uint32_t wrapPauseUntilMs = 0;
  int8_t wrapPauseDir = 0;
  bool wrapArmed = false;
  int8_t wrapArmedDir = 0;
