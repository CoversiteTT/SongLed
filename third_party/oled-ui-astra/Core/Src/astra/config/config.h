...
struct config {
  ...
  float selectorListDurationMs = 220;
  float wrapPauseMs = 300;
  ...
  float listScrollLoopMs = 3000; // long text scroll loop time
  ...
  const unsigned char *logoTitleFont = u8g2_font_zpix;
  const unsigned char *logoCopyRightFont = u8g2_font_zpix;
  const unsigned char *mainFont = u8g2_font_zpix;
